...
COLLEGES = [
    ...
    "사범대학", "음악대학", "조형예술대학", "의과대학", "약학대학",
    "간호과학대학", "경영대학", "신산업융합대학", "인공지능대학", "스크랜튼대학", "호크마교양대학"
]
COLLEGE_MAJORS = {
    "선택 안 함": ["선택 안 함"],
    "인문과학대학": ["선택 안 함", "국어국문학과", "중어중문학과", "불어불문학과", "독어독문학과", "사학과", "철학과", "기독교학과", "영어영문학부"],
    "사회과학대학": ["선택 안 함", "정치외교학과", "행정학과", "경제학과", "문헌정보학과", "사회학과", "사회복지학과", "심리학과", "소비자학과", "커뮤니케이션·미디어학부"],
    "자연과학대학": ["선택 안 함", "수학과", "통계학과", "물리학과", "화학ㆍ나노과학과", "생명과학과"],
    "엘텍공과대학": ["선택 안 함", "융합전자반도체공학부 (전자전기공학전공)", "융합전자반도체공학부 (지능형반도체공학전공)", "식품생명공학과", "화공신소재공학과", "건축학과", "건축도시시스템공학과", "환경공학과", "기후에너지시스템공학과", "휴먼기계바이오공학과"],
    "사범대학": ["선택 안 함", "교육학과", "유아교육과", "초등교육과", "교육공학과", "특수교육과", "영어교육과", "사회과교육과", "국어교육과", "과학교육과"],
    "음악대학": ["선택 안 함", "건반악기과", "관현악과", "성악과", "작곡과", "한국음악과", "무용과"],
    "조형예술대학": ["선택 안 함", "동양화전공", "조소전공", "서양화전공", "도자예술전공", "공간디자인전공", "산업디자인전공", "시각디자인전공", "영상디자인전공", "섬유예술전공", "패션디자인전공"],
    "체육과학부": ["선택 안 함", "체육과학부"],
    "의과대학": ["의학과"],
    "약학대학": ["약학과"],
    "간호과학대학": ["선택 안 함", "간호학전공", "글로벌건강간호학전공"],
    "경영대학": ["선택 안 함", "경영학부"],

    "신산업융합대학": ["선택 안 함", "융합콘텐츠학과", "의류산업학과", "국제사무학과", "식품영양학과", "융합보건학과", "체육과학부"],
    "인공지능대학": ["선택 안 함", "컴퓨터공학과", "사이버보안학과", "인공지능전공", "데이터사이언스전공"],
    "스크랜튼대학": ["선택 안 함", "스크랜튼학부", "뇌·인지과학부", "국제학전공", "글로벌한국학전공"],
    "호크마교양대학": ["글로벌학부"],
}
